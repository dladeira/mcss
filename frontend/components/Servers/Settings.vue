<template>
    <form class="container" @submit.prevent="modifyServer">
        ...
        <div class="bottom-row">
            <SharedFormSlider class="storage" label="Storage Allocated" name="storage" :value="server.storage" :min="server.stats.storageUsed" :max="user.plan.storage" :disabled="connecting" :step="1" />
